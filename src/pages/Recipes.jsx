      ...
      <div id="recipe-box" className="flex overflow-x-scroll gap-x-4">
        {
          recipe.length > 0
            ...
            : (<div className="flex flex-col items-center justify-center w-full py-10">
              <FontAwesomeIcon className="text-gray-600 text-7xl font-thin" icon={faCircleCheck} />
              <div className="py-5 text-center">
                <h1 className="text-2xl font-['GilroyBold']">No New Recipes Yet!</h1>
                <p className="px-[5%] py-2 text-zinc-400">Be the first to add a delicious recipe and share it with the community.</p>
                <button
                  onClick={() => setShowBtn(true)}
                  className="py-3 px-8 bg-red-400 active:scale-[0.95] my-5 rounded-xl transition font-['GilroyRegular'] font-bold text-white/80 ">Add Your Recipe</button>
              </div>
            </div>)
        }

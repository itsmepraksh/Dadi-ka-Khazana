...
const Home = () => {
  ...
  return (
    <div className="py-5 pl-5 md:pl-[7%]">
      <section
        id="hero-section"
      ...
      <section id="categories" className="py-10">
        ...
        <div id="category-link" className="w-full flex flex-row gap-3 py-4 overflow-x-scroll">
          <p className="bg-gray-600/40 px-4 py-1 flex-shrink-[0] rounded">Indian</p>
          <p className="bg-gray-600/40 px-4 py-1 flex-shrink-[0] rounded">Italian</p>
          <p className="bg-gray-600/40 px-4 py-1 flex-shrink-[0] rounded">Quick Meals</p>
          <p className="bg-gray-600/40 px-4 py-1 flex-shrink-[0] rounded">Healthy</p>
        </div>
      </section>
    </div>
  );

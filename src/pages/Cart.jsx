...
//     const subtotal = cart.reduce((acc,item)=> acc + (Number(item.productPrice)* item.quantity),0);
//     const shipping = 50;
//     const total = subtotal + shipping;

//     return (
//         <div className='py-20 px-5 md:px-[7%] lg:w-[50%] xl:w-[40%]  lg:py-[10%]  '>

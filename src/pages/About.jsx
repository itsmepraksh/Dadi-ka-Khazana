...
const About = () => {
  ...
  return (
    <div className="py-20 px-5">
      ...
      <h1 className=" text-center text-xl font-['GilroyRegular'] ">About Us</h1>
      ...
      <div id="about-desc" className="bg-zinc-700 rounded-xl px-6 py-10  flex flex-col gap-6">
        <div id="mission" className="flex gap-4 items-start">
          <FontAwesomeIcon className="bg-red-900/70 text-red-200 p-2 text-2xl rounded-full" icon={faDove} />
          <div id="mission-desc">
        ...
        <div id="team" className="flex gap-4 items-start">
          <FontAwesomeIcon className="bg-red-900/70 text-red-200 p-2 text-2xl rounded-full" icon={faUserGroup} />
          <div id="team-desc">
      ...
      <div id="about-contact" className="py-10 flex flex-col items-center text-center">
